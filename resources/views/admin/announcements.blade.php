...
<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
        ...
        <div class="px-6 py-5 border-b border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h3 class="text-lg font-bold text-gray-900">Manage Announcements</h3>
                <p class="text-xs text-gray-500 mt-0.5">Create and manage public advisories, news, and updates.</p>
            </div>
            ...
            <form>
                <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                    ...
                    <div class="md:col-span-5">
                        ...
                        <div class="relative">
                            <input type="text" placeholder="Search title or content..." class="w-full bg-white border border-gray-300 rounded-xl py-2 pl-10 pr-3 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all shadow-sm">
                    ...
                    <div class="md:col-span-3">
                        <label class="block text-xs font-bold text-gray-700 mb-1.5">Date Posted</label>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 border-b border-gray-100">
                    <tr>
                        <th class="px-6 py-4 font-bold tracking-wider w-[50%]">Announcement Details</th>
                        <th class="px-6 py-4 font-bold tracking-wider">Status</th>
                        <th class="px-6 py-4 font-bold tracking-wider">Date Posted</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="bg-white hover:bg-gray-50 transition-colors group">
                        <td class="px-6 py-4">
                            <div class="font-bold text-gray-900 text-base mb-1">Important: Water Service Interruption</div>
                            <p class="text-sm text-gray-500 line-clamp-2">Please be advised that there will be a scheduled water interruption tomorrow, Jan 15, from 8:00 AM to 5:00 PM due to mainline repairs in Purok 3 and 4...</p>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex justify-end gap-2">
                                <button onclick="openModal('viewModal')" class="p-2 bg-blue-100 text-blue-600 rounded-lg hover:bg-blue-200 shadow-sm transition-all" title="View Full Content">
                    ...
                    <tr class="bg-white hover:bg-gray-50 transition-colors group">
                        <td class="px-6 py-4">
                            <div class="font-bold text-gray-900 text-base mb-1">Upcoming Barangay Assembly</div>
                            <p class="text-sm text-gray-500 line-clamp-2">Drafting agenda for the upcoming quarterly assembly. Topics include budget proposal and new project proposals.</p>
                        </td>
                        <td class="px-6 py-4">
        ...
        <div class="bg-gray-50 px-6 py-4 border-t border-gray-100 flex items-center justify-between">
            <span class="text-sm text-gray-500">Showing <span class="font-bold text-gray-900">1</span> to <span class="font-bold text-gray-900">10</span> of <span class="font-bold text-gray-900">24</span> entries</span>
    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl transform transition-all border border-gray-100 overflow-hidden">
            ...
            <div class="bg-slate-50 px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                <h3 class="text-lg font-bold text-gray-900">Create / Edit Announcement</h3>
            ...
            <div class="p-6 space-y-4">
                <div>
                    ...
                    <input type="text" placeholder="Enter announcement title" class="w-full bg-white border border-gray-300 rounded-xl py-3 px-4 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all shadow-sm">
                </div>
                <div>
                ...
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">Content / Details</label>
                    <textarea rows="6" placeholder="Write the announcement details here..." class="w-full bg-white border border-gray-300 rounded-xl py-3 px-4 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all shadow-sm resize-none"></textarea>
                </div>
            </div>
            ...
            <div class="bg-gray-50 px-6 py-4 flex justify-end gap-3 border-t border-gray-100">
                ...
                <button class="px-5 py-2.5 text-sm font-bold text-white bg-slate-900 rounded-xl hover:bg-slate-800 shadow-md transition-all">Save Announcement</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl transform transition-all border border-gray-100 overflow-hidden">
            ...
            <div class="bg-blue-50 px-6 py-4 border-b border-blue-100 flex items-center justify-between">
                <div>
                    <h3 class="text-lg font-bold text-blue-900">Announcement Details</h3>
                    <p class="text-xs text-blue-600 mt-0.5">Posted on Jan 14, 2026</p>
                </div>
            ...
            <div class="p-8">
                ...
                <h2 class="text-2xl font-bold text-gray-900 mb-4">Important: Water Service Interruption</h2>
                
                <div class="prose prose-sm prose-slate max-w-none text-gray-600 leading-relaxed">
                    <p>Please be advised that there will be a scheduled water interruption tomorrow, <strong>Jan 15, 2026</strong>, from <strong>8:00 AM to 5:00 PM</strong>.</p>
                    <p class="mt-2">This interruption is due to necessary mainline repairs and maintenance works in <strong>Purok 3 and Purok 4</strong>. We advise all affected residents to store enough water for their daily needs during this period.</p>
                    <p class="mt-4 italic">We apologize for the inconvenience and appreciate your understanding.</p>
                </div>
            </div>
