...
<div class="max-w-[1600px] mx-auto py-10 px-6 font-sans antialiased text-slate-900">
    ...
    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-10">
        ...
        <div class="flex flex-wrap gap-4">
            <button
                onclick="document.getElementById('importCaseModal')?.classList.remove('hidden')"
            ...
            <button
                class="bg-slate-900 hover:bg-slate-800 text-white text-[11px] font-black uppercase tracking-widest px-8 py-4 rounded-2xl
                       transition-all shadow-xl shadow-slate-900/20 flex items-center gap-3 hover:-translate-y-1
            ...
            <div>
                <button
                    class="bg-slate-900 hover:bg-slate-800 text-white font-black text-[11px] uppercase tracking-widest
                           px-8 rounded-2xl transition-all shadow-lg shadow-slate-900/20 h-[54px]"
                >
                    Filter
                </button>
            </div>
    ...
    <div class="bg-white rounded-[2.5rem] shadow-2xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
        ...
        <div class="bg-slate-900 px-8 py-5 flex items-center gap-4">
            ...
            <h2 class="text-white font-black tracking-[0.2em] uppercase text-sm">
                Cases Registry List
            </h2>
        </div>
                    ...
                    <tr class="hover:bg-slate-50 transition-all group">
                        ...
                        <td class="px-8 py-6 align-top">
                            <div class="space-y-1.5">
                                <div class="flex items-center gap-2">
                                    <span class="text-[9px] font-black text-slate-900 bg-slate-100 px-1.5 py-0.5 rounded uppercase tracking-widest">
                                        Comp
                                    </span>
                                    <span class="text-sm font-bold text-slate-800">Juan Dela Cruz</span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <span class="text-[9px] font-black text-rose-700 bg-rose-50 px-1.5 py-0.5 rounded uppercase tracking-widest">
                                        Resp
                                    </span>
                        ...
                        <td class="px-8 py-6 align-top">
                            <div class="flex flex-col">
                                ...
                                <span class="text-[9px] text-slate-700 font-black uppercase tracking-widest mt-0.5">10:00 AM</span>
                            </div>
                        </td>
                        ...
                        <td class="px-8 py-6 align-top">
                            <div class="flex items-center gap-3">
                                ...
                                <select class="bg-white border border-slate-200 text-[10px] font-black uppercase rounded-lg px-2 py-1
                                               focus:ring-2 focus:ring-slate-900 outline-none text-slate-600 cursor-pointer
                        ...
                        <td class="px-8 py-6 align-top text-center">
                            <div class="flex justify-center gap-4">
                                <button title="View" class="text-slate-400 hover:text-slate-900 hover:scale-110 transition-transform">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <button title="Delete" class="text-rose-400 hover:text-rose-600 hover:scale-110 transition-transform">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
        ...
        <div class="bg-slate-50 px-8 py-5 border-t border-slate-100 flex justify-between items-center text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">
            ...
            <div class="flex gap-2">
                <button class="w-8 h-8 flex items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-400 hover:text-slate-900 hover:border-slate-400 transition-all">
